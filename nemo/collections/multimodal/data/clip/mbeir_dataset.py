...
class MBEIRDatasetBase(Dataset):
    """This serves as the base class for creating datasets.
     It contains methods for loading data, including query data, candidate pool data, and query instructions."""
    def __init__(
...
class MBEIRMainDataset(MBEIRDatasetBase):
    """This class inherits from MBEIRDatasetBase and is specialized for the main MBEIR dataset.
     It loads query data, candidate pool data, and query instructions. 
    It also implements methods for retrieving individual data instances."""
    def __init__(
        self,
...
class MBEIRCandidatePoolDataset(MBEIRDatasetBase):
    """This class inherits from MBEIRDatasetBase and is specialized for the candidate pool dataset.
     It loads candidate pool data and implements methods for retrieving individual data instances."""
    def __init__(
        self,
        mbeir_data_dir,  # Root directory of the MBEIR dataset
...
class MBEIRCollatorBase(object):
    """This serves as the base class for creating collators, which are used for grouping and preprocessing data for efficient processing.
     It contains methods for padding text and images."""
    @typechecked
...
class MBEIRMainCollator(MBEIRCollatorBase):
    """This class inherits from MBEIRCollatorBase and is specialized for the main MBEIR dataset.
     It preprocesses batches of data instances, including text and image inputs."""
...
class MBEIRCandidatePoolCollator(MBEIRCollatorBase):
    """This class inherits from MBEIRCollatorBase and is specialized for the candidate pool dataset.
     It preprocesses batches of candidate data instances, including text and image inputs."""
